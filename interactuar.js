//jQuery para cuando se cargue el DOM
 $(document).ready(function(){
  ...
  $('form').submit(function(){
     ...
     if(edad < 30){
      //Indigo
      $('body').css("background-color","#e6ceff");
      $('#footer').css("background-color","#a094b7");
      ...
      //Pink
      $('body').css("background-color","#c9b2ba");
      $('#footer').css("background-color","#f8bbd0");
      ...
      $('#footer').css("background-color","#aabb97");
